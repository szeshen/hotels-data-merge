...
// ListHotels provides a mock function with given fields:
func (_m *MockHotelRepository) ListHotels() map[string][]Hotel {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() map[string][]Hotel); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
